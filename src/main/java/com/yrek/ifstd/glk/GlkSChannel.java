...
public abstract class GlkSChannel extends GlkObject {
    ...
    public abstract boolean playExt(int resourceId, int repeats, int notify) throws IOException;
    ...
    public abstract void setVolumeExt(int volume, int duration, int notify) throws IOException;
}
